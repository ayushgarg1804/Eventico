...
function getSize( elem ) {
  ...
  var size_tmp = elem.getBoundingClientRect();
...
Item.prototype.getPosition = function() {
  ...
  var x = parseFloat( style[ isOriginLeft ? 'left' : 'right' ], 10 );
  var y = parseFloat( style[ isOriginTop ? 'top' : 'bottom' ], 10 );
...
function masonryDefinition( Outlayer, getSize ) {
  ...
  Masonry.prototype.measureColumns = function() {
    ...
    this.getContainerWidth();
    this.columnWidth += this.gutter;
    this.columnWidth = this.containerWidth / 12;
    this.cols = 12;
  };
  ...
  Masonry.prototype._getItemLayoutPosition = function( item ) {
    item.getSize();//console.log(item.size);
    // how many columns does this brick span
    var colSpan = Math.ceil( item.size.outerWidth / this.columnWidth );//console.log(item.size.outerWidth,this.columnWidth,colSpan);
    ...
    var position = {
      ...
      y: minimumY
    };//console.log(colSpan, this.cols, colGroup, minimumY, shortColIndex, position);
